...
// WARNING: Does not work on orion - dies without a message - Sotiris must have blocked the port?
// 	    send locally instead ...
$to = "potam@orion.telecom.tuc.gr";
// --------------------------------------//
...
die("<span class='success'><h3>Successfully Sent!</h3> Thanks for your message! </span>");
